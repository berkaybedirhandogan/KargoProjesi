...
Bu proje, Web Tabanlı Programlama dersi için hazırlanmış, kargoların uçtan uca takibini sağlayan bir **ASP.NET Core MVC** uygulamasıdır. Kullanıcılar kargolarını kaydedebilir, durumlarını güncelleyebilir ve harita üzerinden lokasyonlarını takip edebilirler.
...
---
Video Linki: https://www.youtube.com/watch?v=Sf5I_RLuWeU
